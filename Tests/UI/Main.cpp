...
void coreInit()
{
    ...
    cssFile = SGCore::AssetManager::getInstance()->loadAsset<SGCore::UI::CSSFile>(demosPath / "Tests/UI/Resources/test.css");
    uiDocument = SGCore::AssetManager::getInstance()->loadAsset<SGCore::UI::UIDocument>(demosPath / "Tests/UI/Resources/test.xml");
