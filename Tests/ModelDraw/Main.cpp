...
void coreInit()
{
    ...
    // loading audio ================================================================================================
    copterSound = SGCore::AssetManager::getInstance()->loadAsset<SGCore::AudioTrackAsset>(demosPath / "Tests/ModelDraw/Resources/drone/copter.wav");
    copterSound->toMono();
    ...
    auto& modelAssetLoadSlot = modelAsset->onLazyLoadDone += [demosPath](SGCore::IAsset* thisAsset) {
